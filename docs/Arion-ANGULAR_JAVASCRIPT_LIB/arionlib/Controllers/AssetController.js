...
angular.module('ArionLib')
    ...
    function AssetController($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
            /**
            ...
            asset: function (body) {
                ...
                var _queryBuilder = _baseUri + '/assets';
            ...
            assetById: function () {
                ...
                //prepare query string for API call
                var _baseUri = Configuration.getBaseUri();
                var _queryBuilder = _baseUri + '/assets/1';
